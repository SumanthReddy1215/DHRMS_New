    ...
    _create: function(){
        ...
        if (o.multiselect) {
            ...
            function autoSize(e) {
                // Hackish autosizing
                var $this = $(this);
                //console.log($this.innerWidth() + fontSize - 1);
            ...
            self.element.bind({
                "keydown.autocomplete": function(e){
                    ...
                    if (o.triggerChar && e.key == o.triggerChar && this.value !== "")
                    {
                        e.stopPropagation();
                        o.select(e, { item: { label: this.value } });
                        return false;
                    }
                },
            ...
            o.select = o.select || function (e, ui) {
                if (o.onSelect(ui.item, self.selectedItems)) {
                    $("<div></div>")
